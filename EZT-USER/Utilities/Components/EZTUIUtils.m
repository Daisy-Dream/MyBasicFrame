...
{
    CAShapeLayer *maskLayer = [EZTUIUtils makeShapelayerWithRoundingCorners:UIRectCornerAllCorners
                                                                    forView:view
...
{
    CAShapeLayer *maskLayer = [EZTUIUtils makeShapelayerWithRoundingCorners:(UIRectCornerTopLeft|
...
{
    CAShapeLayer *maskLayer = [EZTUIUtils makeShapelayerWithRoundingCorners:(UIRectCornerBottomLeft|
...
{
    CAShapeLayer *maskLayer = [EZTUIUtils makeShapelayerWithRoundingCorners:(UIRectCornerTopRight  |
                                                                             UIRectCornerBottomRight)
                                                                    forView:view
                                                           withCornerRadius:radius];
    view.layer.mask = maskLayer;
